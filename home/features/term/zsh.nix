  ...
  programs = {
    zsh = {
      ...
      shellAliases = with pkgs;{
        ...
        "..." = "cd ../..";
        "...." = "cd ../../..";
        cdw = "cd ${config.programs.zsh.sessionVariables.WORK}"; ## goto working project folder
        cdp = "cd ${config.programs.zsh.sessionVariables.PRIVATE}"; ## goto private project folder
